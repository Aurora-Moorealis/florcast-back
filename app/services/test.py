...
@app.post("/api/region", response_model=RegionResponse)
...
@app.get("/api/global-sample", response_model=RegionResponse)
...
@app.get("/api/hotspots", response_model=RegionResponse)
